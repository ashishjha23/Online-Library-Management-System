...
<body>
	...
	redirect_to("http://localhost/bc.php");
		...
		<a href="/login/logout" >Click to Log Out</a></br>
	...
	?></br><a href="/student input/stuip.php" ><font size="4"><br />Book Issue</font></a>
			...
			<ul>
				...
				<li>
					...
					<div class="details">
						...
						<p class="description">Issue Status:<?php echo $row['issue_status'];?></p>
...
while($row= mysqli_fetch_assoc($result)){
		...
		?>
								...
								<span  class="holder">
									...
									<span class="author">Issue Status:<?php echo $row['issue_status'];?></span>
